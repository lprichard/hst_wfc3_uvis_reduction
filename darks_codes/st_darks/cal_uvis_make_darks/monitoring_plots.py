...
class MonitoringPlot():
    ...
    def __init__(self):
        ...
        """
        self.anneal_list = get_history_list('anneal')
        self.sicdh_list = get_history_list('SIC&DH')
    ...
    def plot_rec(self, x, y, output):
        ...
        # Save plot
        plt.savefig(output)
        logging.info('\tSaved monitoring plot to {}'.format(output))
...
def get_history_list(hist_type):
    ...
    # Build grep command
    history_file = '/grp/hst/wfc3b/calibration/history.txt'
